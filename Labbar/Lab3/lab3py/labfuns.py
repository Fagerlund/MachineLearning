...
def fetchDataset(dataset='iris'):
    if dataset == 'iris':
        X = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\irisX.txt', delimiter=',')
        y = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\irisY.txt', delimiter=',',dtype=np.int)-1
        pcadim = 2
    elif dataset == 'wine':
        X = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\wineX.txt', delimiter=',')
        y = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\wineY.txt', delimiter=',',dtype=np.int)-1
        pcadim = 0
    elif dataset == 'olivetti':
        X = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\olivettifacesX.txt', delimiter=',')
        X = X/255
        y = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\olivettifacesY.txt', delimiter=',',dtype=np.int)
        pcadim = 20
    elif dataset == 'vowel':
        X = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\vowelX.txt', delimiter=',')
        y = genfromtxt(r'C:\Users\henri\OneDrive\KTH\Year 4\Machine Learning\Labbar\Lab3\lab3py\vowelY.txt', delimiter=',',dtype=np.int)
        pcadim = 0
    else:
